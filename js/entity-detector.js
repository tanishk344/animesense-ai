...
const EntityDetector = (() => {
    ...
    const INTENTS = {
        ...
        FACTUAL: /\b(how many\s+episodes?|total\s+episodes?|episode\s+count|number of\s+episodes?|episodes?\s*$|when did.*air|release date|studio.*name|who is the main character)\b/i,
